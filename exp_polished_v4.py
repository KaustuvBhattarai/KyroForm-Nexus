...
# Prepare logo (circle-cropped) for page icon and header image if available
...
with main_col:
    ...
    if st.button("Predict Interaction") and human_id and bact_id:
        ...
        # Fetch UniProt info early so details panels can use them
        ...
        # Prediction tab: indicator + quick stats
        with tab1:
            ...
            # Move Protein Details here (after indicator + color index)
            ...
            # Place Similar Proteins after protein details (bottom of Prediction tab)
...
# Side column removed to use full page width for main UI
